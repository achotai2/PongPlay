...
# Main game loop
    ...
    leftMove  = leftAgent.Brain( paddle_a.xcor(), paddle_a.ycor(), paddle_b.xcor(), paddle_b.ycor(), ball.xcor(), ball.ycor(), ball.dx, ball.dy )
    rightMove = rightAgent.Brain( paddle_a.xcor(), paddle_a.ycor(), paddle_b.xcor(), paddle_b.ycor(), ball.xcor(), ball.ycor(), ball.dx, ball.dy )
